...
<img src="./images/img11.jpg" alt="리스트이미지 방법1 - 연혁">
...
<head>
    ...
    <style>
        *{margin:0; padding:0}
        body{font-family: '에스코어드림';font-size: 14px; color:#333}
        ul{list-style: none}
        .history{width:750px;margin: 30px}
        .history li{border:1px solid #333; margin-bottom: 20px; overflow: hidden}
        .history dl{margin: 10px 0;}
        .history dt{float: left; margin:30px}
        .history dd{font-size: 1em; line-height: 1.5em; margin-left: 190px;
...
<img src="./images/img11.jpg" alt="리스트이미지 방법2">
...
<head>
    ...
    <style>
        *{margin:0; padding:0}
        ...
        ul{list-style: none}
        .history{width:750px;margin: 30px}
        .history li{border:1px solid #333;
                    margin-bottom: 20px;
                    position:relative}
        .history dl{margin: 10px 0}
        .history dt{position: absolute;left: 30px; top:30px}
        .history dd{font-size: 1em; line-height: 1.5em; margin-left: 190px;
                    background: url(./images/dot.jpg)left center no-repeat;
                    padding-left: 20px;}
    </style>
